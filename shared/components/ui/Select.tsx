/**
 * Custom Select dropdown — glassmorphic design system.
 *
 * Replaces native <select> elements with a fully styled, accessible dropdown
 * that matches the dark glassmorphism theme. Based on frontend-public CustomSelect.
 *
 * Features:
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          boxShadow: isOpen ? '0 0 0 2px rgba(0, 191, 165, 0.15)' : 'none',
          textAlign: 'left',
          position: 'relative',
          outline: 'none',
          ...
          {allOptions.map((option, index) => (
            <div
              ...
              style={{
                ...
                background:
                  focusedIndex === index ? 'rgba(205, 94, 129, 0.18)' : 'transparent',
                cursor: 'pointer',
                fontSize: 'var(--text-sm)',
                fontFamily: 'var(--font-body)',
