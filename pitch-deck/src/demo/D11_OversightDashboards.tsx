...
const oversightRoles = [
  {
    ...
    features: ["Ward-specific ticket view", "Community performance metrics", "Citizen satisfaction scores"],
    delay: 20,
  },
  {
    ...
    tier: "Tier 2 \u2014 Oversight",
    tierColor: colors.coral,
    features: ["Financial compliance dashboard", "Risk register access", "Audit finding tracking"],
    delay: 28,
  },
  {
    ...
    features: ["Audit trail viewer", "Process compliance checks", "Evidence verification"],
    delay: 36,
  },
  {
    role: "MPAC",
    tier: "Tier 2 \u2014 Oversight",
    tierColor: colors.coral,
    features: ["Annual report review", "Oversight resolution tracking", "Performance assessment"],
    delay: 44,
  },
];
